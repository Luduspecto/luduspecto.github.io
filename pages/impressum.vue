<template>
    <LandingContainer>
        ...
        <div class="container mt-16 font-light" data-text-language="de">
            ...
            <p class="text-base">Kranabetter & Nadler GbR<br />Kormoranweg 8, <br />81827 München,
                <br />Deutschland
            </p>
            <p class="text-base">
            </p>
            <p class="text-base">
                <strong>Tel.:</strong> 01701813395<br />
                <strong>E-Mail:</strong> <a href="mailto:lucuspecto@gmail.com">lucuspecto@gmail.com</a>
            </p>
            <p class="text-base">
                <strong>Berufsbezeichnung:</strong> Anwendungsentwickler
            </p>
            <p class="text-base">
                <strong>Vertreten durch die Gesellschafter</strong>
                <br />Sebastian Nadler, Maximilian Kranabetter
            </p>
            <p style="margin-top:15px;">Quelle: Erstellt mit dem <a title="Impressum Generator Deutschland"
                    href="https://www.adsimple.de/impressum-generator/" target="_blank" rel="follow"
            ...
            <p>Gemäß Verordnung über Online-Streitbeilegung in Verbraucherangelegenheiten (ODR-Verordnung) möchten wir
                ...
                Kommission unter <a class="text-base"
                    href="https://ec.europa.eu/consumers/odr/main/index.cfm?event=main.home2.show&amp;lng=DE"
                    target="_blank" rel="noopener">http://ec.europa.eu/odr?tid=321221418</a> zu richten. Die dafür
            ...
            <p>Wir entwickeln die Inhalte dieser Webseite ständig weiter und bemühen uns korrekte und aktuelle
                ...
                bereitzustellen. Laut Telemediengesetz <a class="text-base"
                    href="https://www.gesetze-im-internet.de/tmg/__7.html?tid=321221418" rel="noopener"
                    target="_blank">(TMG) §7
                    (1)</a> sind wir als Diensteanbieter für eigene Informationen, die wir zur
                Nutzung bereitstellen, nach den allgemeinen Gesetzen verantwortlich. Leider können wir keine Haftung für
                die
                Korrektheit aller Inhalte auf dieser Webseite übernehmen, speziell für jene die seitens Dritter
                bereitgestellt wurden. Als Diensteanbieter im Sinne der §§ 8 bis 10 sind wir nicht verpflichtet, die von
                ihnen übermittelten oder gespeicherten Informationen zu überwachen oder nach Umständen zu forschen, die
                auf
            ...
            <p>Unsere Verpflichtungen zur Entfernung von Informationen oder zur Sperrung der Nutzung von Informationen
                ...
                unserer Nichtverantwortlichkeit nach den §§ 8 bis 10 unberührt. </p>
